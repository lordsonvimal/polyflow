...
`docs/versioning-matrix-plan.md`, `docs/evidence-fusion-plan.md`) all follow this
process. The original gap-closing plan that carried these rules is complete and was
