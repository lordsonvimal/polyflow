...
- `docs/cross-service-precision-plan.md` (Tier J) — after Tier W and
  ...
  Closes the 2026-08-06 fleet-juniper audit: ~75% of cross-service
...
found 2026-07-28 (combined go-svcc/go-svcb/maple index measured
...
`orion/app/services/atlas/user_category_rules_client.rb:22`'s outbound call to
Atlas is indexed as a *route in orion* — one missed cross-service link plus a
