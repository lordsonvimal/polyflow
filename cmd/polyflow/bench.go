...
func runBench(cmd *cobra.Command, args []string) error {
	...
	// nextGen/datascience/etc. do. --settings injects them by absolute path
...
// PreToolUse hooks from the *target* repo's own settings, and nextGen/
// datascience/etc. don't carry a copy.
