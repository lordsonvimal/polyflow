...
// TestScanRenders_Spellings covers the four Rails forms orion actually uses.
...
// are as static as their quoted forms, and are a quarter of orion's
...
// off. There is no view to ledger — 17 of orion's controller renders spell it.
