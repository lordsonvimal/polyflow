...
func TestDependenciesTable(t *testing.T) {
	...
	require.NoError(t, store.UpsertDependency(ctx, &Dependency{
		Service: "svc-c-agent", Ecosystem: "go", Name: "github.com/aws/aws-sdk-go",
		Version: "v1.55.8", Kind: "prod",
	}))
	require.NoError(t, store.UpsertDependency(ctx, &Dependency{
		Service: "svc-c-mgr", Ecosystem: "go", Name: "github.com/aws/aws-sdk-go-v2/service/s3",
		Version: "v1.66.0", Kind: "prod",
	}))
	require.NoError(t, store.UpsertDependency(ctx, &Dependency{
		Service: "cedar", Ecosystem: "npm", Name: "jquery", Version: "3.7.1", Kind: "dev",
	}))

	// "What version of aws-sdk-go does svc-c-agent use?"
	agent, err := store.ListDependencies(ctx, "svc-c-agent")
	require.NoError(t, err)
