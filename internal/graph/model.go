...
// juniper fleet 2026-08-09: 8 of 30 cross-service `publishes` edges ran
// backwards along the message flow, claiming maple-manager published the runner
// heartbeats it consumes and maple-agent published the build jobs it binds.
//
