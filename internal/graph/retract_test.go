...
// datascience fleet 1324 of 1668 inherits_unresolved entries (79%) had a real
...
func TestRetractResolvedRefs_DropsFalseAlarm(t *testing.T) {
	...
	nodes := []Node{
		retractNode("n1", "nextGen", ctrl, "LrosController"),
		retractNode("n2", "nextGen", base, "ApiBaseController"),
	}
	edges := []Edge{{ID: "e1", From: "n1", To: "n2", Type: EdgeTypeInherits}}
	refs := []UnresolvedRef{
		{Service: "nextGen", File: ctrl, Line: 7, Name: "ApiBaseController", Kind: "inherits_unresolved"},
	}
...
func TestRetractResolvedRefs_KeepsGenuineGap(t *testing.T) {
	...
	nodes := []Node{retractNode("n1", "nextGen", ctrl, "LrosController")}
	refs := []UnresolvedRef{
		{Service: "nextGen", File: ctrl, Line: 7, Name: "MissingConcern", Kind: "inherits_unresolved"},
	}
