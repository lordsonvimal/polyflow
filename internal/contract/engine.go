...
//
// Measured on the datascience fleet (2026-08-08): 205 http_handler nodes lived
// in test files and were being matched as real endpoints — `handlers_test.go:27`
// was linked as dsw-agent's `/health` endpoint, and a settings controller test
// as dsw-manager's `PUT /api/v1/settings`.
