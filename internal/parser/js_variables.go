...
func (ex *jsExtractor) stampGlobalSymbols(root *sitter.Node) {
	...
	// namespaced/wrapped registrations (window.dsw.foo = …, inside IIFEs/modules).
...
//
//	window.dsw.closeVulnerabilityModal  -> ("window.dsw.closeVulnerabilityModal", "closeVulnerabilityModal", true)
