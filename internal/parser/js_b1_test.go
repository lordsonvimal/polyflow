...
`)
	_, edges, _ := extractJSVariables("app.js", "web", "javascript", "javascript", src)
...
`)
	_, edges, _ := extractJSVariables("form.tsx", "web", "tsx", "tsx", src)
...
function init() {
  register(save);
	...
	libNodes, libEdges, _ := extractJSVariables(libFile, "web", "javascript", "javascript", libSrcB)
	mainNodes, mainEdges, _ := extractJSVariables(mainFile, "web", "javascript", "javascript", mainSrcB)
