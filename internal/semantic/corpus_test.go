	...
	cases := []struct {
		...
		},
		{
			...
			node: graph.Node{
				...
				Type: graph.NodeTypeFunction, Service: "nextgen-cam",
			...
			want: "create function nextgen-cam app/controllers/api/v1/license_report_jobs_controller.rb LicenseReportJobsController#create",
		},
		{
...
// TestBuildFlowChains_WorkerPrependsLaunchPath reproduces the datascience
...
// finding: a datascience reindex produced a launch prefix with a hop
