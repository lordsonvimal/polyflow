...
//
//	main.go              NewTilePublisher(config.DSWManagerAPIURL, …)
//	tile_publisher.go    NewDSWManagerUserAppClient(apiURL, authToken)
//	client.go            &DSWManagerUserAppClient{baseURL: baseURL}
//
...
// at the second line. Knowing that callers pass DSW_MANAGER_API_URL to
// NewTilePublisher's parameter 0 is exactly what licenses carrying it to
// NewDSWManagerUserAppClient's parameter 0.
//
