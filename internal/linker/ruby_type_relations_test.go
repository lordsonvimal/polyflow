...
// lib (orion, orion-vega-agent and orion-lyra-agent all ship a lib/dx.rb), a
// single `include Dx` bound to every copy — 221 phantom edges from one statement,
// 744 across the 8-service juniper fleet.
//
...
// two RepositoryControllers orion ships — one top level, one under
