...
`,
		...
		"app/assets/javascripts/cdr/cdr.js":          "function cdr() {}",
		"app/assets/javascripts/cdr/deep/nested.js":  "function nested() {}",
	...
	require.Equal(t, []string{
		filepath.Join(js, "cdr/cdr.js"),
		filepath.Join(js, "cdr/deep/nested.js"), // require_tree is recursive
