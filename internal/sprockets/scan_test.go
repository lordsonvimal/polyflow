...
// TestScanDirectives_HeaderBlock is orion's application.js shape: a grouped
...
`))
	...
	require.Equal(t, []Directive{
		...
		{Verb: "require_tree", Path: "./vega", Line: 9},
	}, got)
}
...
// TestScanIncludeTags_Literals covers orion's four real spellings, including
...
// TestScanIncludeTags_CommentedOutIsNotALoad: orion has three commented-out
